 ...
 */
#define TCPC_EVENT_PCB_ASSIGN_TCPS_CLOSE_WAIT 0
#define TCPC_EVENT_PCB_ASSIGN_TCPS_CLOSED 1
#define TCPC_EVENT_PCB_ASSIGN_TCPS_SYN_SENT 2
#define TCPC_EVENT_PCB_ASSIGN_TCPS_SYN_RECEIVED 3
#define TCPC_EVENT_PCB_ASSIGN_TCPS_CLOSING 4
#define TCPC_EVENT_PCB_ASSIGN_TCPS_TIME_WAIT 5
#define TCPC_EVENT_PCB_ASSIGN_TCPS_ESTABLISHED 6
#define TCPC_EVENT_PCB_ASSIGN_TCPS_LAST_ACK 7
#define TCPC_EVENT_PCB_ASSIGN_TCPS_FIN_WAIT_1 8
#define TCPC_EVENT_PCB_ASSIGN_TCPS_FIN_WAIT_2 9
