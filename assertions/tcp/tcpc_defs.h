...
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_LISTEN 6
#define TCPC_EVENT_FUNC_PROLOGUE_TCP_FREE 7
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_SYN_SENT 8
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_CLOSE_WAIT 9
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_SYN_RECEIVED 10
#define TCPC_EVENT_TP_T_STATE_ASSIGN_TCPS_TIME_WAIT 11
